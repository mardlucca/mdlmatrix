...
class Abs {
  public:
    inline static void operate(double op1, double& out) {
      out = std::abs(op1);
    }

    inline static void operate(double& op1) {
      op1 = std::abs(op1);
    }
};
...
class Addition {
  public:
    inline static void operate(double op1, double op2, double& out) {
      out = op1 + op2;
    }

    inline static void operate(double& op1, double op2) {
      op1 += op2;
    }
};
